	...
	CommandLineRunner init(UsuarioRepository userRepository, ColeccionRepository coleccionRepository, ProductoRepository productoRepository) {
		return args -> {
			...
			Producto algodonDulceBodySplash = Producto.builder()
					...
					.imagenProducto("static/img/coleccion/body-splash/algodon-dulce-100.png")
					.stockProducto(50)
			...
			Producto chicleSandiaBodySplash = Producto.builder()
					...
					.tamanoProducto(100)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/body-splash/chicle-sandia-100.png")
					.stockProducto(50)
					.coleccion(bodySplash)
					.reviewsProducto(null)
					.build();
			...
			Producto cupcakeVainillaBodySplash = Producto.builder()
					...
					.tamanoProducto(100)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/body-splash/cupcake-vainilla-100.png")
					.stockProducto(50)
					.coleccion(bodySplash)
					.reviewsProducto(null)
					.build();
			...
			Producto milkshakeFresaBodySplash = Producto.builder()
					...
					.tamanoProducto(100)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/body-splash/milkshake-fresa-100.png")
					.stockProducto(50)
					.coleccion(bodySplash)
					.reviewsProducto(null)
					.build();
			...
			Producto algodonDulceExfolianteCorporal = Producto.builder()
					...
					.tamanoProducto(300)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/exfoliante/corporal/algodon-dulce-300.png")
					.stockProducto(50)
			...
			Producto chicleSandiaExfolianteCorporal = Producto.builder()
					...
					.tamanoProducto(300)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/exfoliante/corporal/chicle-sandia-300.png")
					.stockProducto(50)
					.coleccion(exfolianteCorporal)
					.reviewsProducto(null)
					.build();
			...
			Producto mangoTropicalExfolianteCorporal = Producto.builder()
					...
					.tamanoProducto(300)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/exfoliante/corporal/mango-tropical-300.png")
					.stockProducto(50)
					.coleccion(exfolianteCorporal)
					.reviewsProducto(null)
					.build();
			...
			Producto milkshakeFresaExfolianteCorporal = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/exfoliante/corporal/milkshake-fresa-200.png")
					.stockProducto(50)
					.coleccion(exfolianteCorporal)
					.reviewsProducto(null)
					.build();
			...
			Producto milkshakeFresaExfolianteCorporal2 = Producto.builder()
					...
					.tamanoProducto(300)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/exfoliante/corporal/milkshake-fresa-300.png")
					.stockProducto(50)
					.coleccion(exfolianteCorporal)
					.reviewsProducto(null)
					.build();
			...
			Producto algodonDulceMantecaCorporal = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/corporal/algodon-dulce-200-1.png")
					.stockProducto(50)
			...
			Producto algodonDulceMantecaCorporal2 = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/corporal/algodon-dulce-200-2.png")
					.stockProducto(50)
					.coleccion(mantecaCorporal)
					.reviewsProducto(null)
					.build();
			...
			Producto chicleSandiaMantecaCorporal = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/corporal/chicle-sandia-200-1.png")
					.stockProducto(50)
					.coleccion(mantecaCorporal)
					.reviewsProducto(null)
					.build();
			...
			Producto chicleSandiaMantecaCorporal2 = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/corporal/chicle-sandia-200-2.png")
					.stockProducto(50)
					.coleccion(mantecaCorporal)
					.reviewsProducto(null)
					.build();
			...
			Producto cupcakeVainillaMantecaCorporal = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/corporal/cupcake-vainilla-200-1.png")
					.stockProducto(50)
					.coleccion(mantecaCorporal)
					.reviewsProducto(null)
					.build();
			...
			Producto cupcakeVainillaMantecaCorporal2 = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/corporal/cupcake-vainilla-200-2.png")
					.stockProducto(50)
					.coleccion(mantecaCorporal)
					.reviewsProducto(null)
					.build();
			...
			Producto milkshakeFresaMantecaCorporal = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/corporal/milkshake-fresa-200-1.png")
					.stockProducto(50)
					.coleccion(mantecaCorporal)
					.reviewsProducto(null)
					.build();
			...
			Producto milkshakeFresaMantecaCorporal2 = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/corporal/milkshake-fresa-200-2.png")
					.stockProducto(50)
					.coleccion(mantecaCorporal)
					.reviewsProducto(null)
					.build();
			...
			Producto algodonDulceMantecaEmulsionada = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/emulsionada/algodon-dulce-200.png")
					.stockProducto(50)
			...
			Producto chicleSandiaMantecaEmulsionada = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/emulsionada/chicle-sandia-200.png")
					.stockProducto(50)
					.coleccion(mantecaEmulsionada)
					.reviewsProducto(null)
					.build();
			...
			Producto cupcakeVainillaMantecaEmulsionada = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/emulsionada/cupcake-vainilla-200.png")
					.stockProducto(50)
					.coleccion(mantecaEmulsionada)
					.reviewsProducto(null)
					.build();
			...
			Producto milkshakeFresaMantecaEmulsionada = Producto.builder()
					...
					.tamanoProducto(200)
					.beneficiosProducto("Muchos beneficios")
					.imagenProducto("static/img/coleccion/manteca/emulsionada/milkshake-fresa-200.png")
					.stockProducto(50)
					.coleccion(mantecaEmulsionada)
					.reviewsProducto(null)
					.build();
			...
			*/
			...
			Usuario userMartin = Usuario.builder()
					...
					.contrasenaUsuario("$2a$10$xxQtR1FOIIEQjPNSajw1S.Ejsjldaz95vhARVYZ0/zZZL4wuyju3.")
					.isEnabled(true)
